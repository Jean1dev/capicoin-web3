    ...
    return (
        <section className="trade-securely">
          ...
          <div className="card card--white">
            <div className="currency-icon">
              <img alt="BNB" src={"/images/bnb.svg"} />
            </div>
            <div className="card__header">
          ...
          <div className="card card--white">
            <div className="currency-icon">
              <img alt="PanCake" src={"images/pancake.svg"} />
            </div>
            <div className="card__header">
            ...
            <button className="btn btn--flex btn--accent">
              ...
              <div className="chiron-icon-container">
                <img src={"images/chevron-rigth.svg"} alt="Right Icon" />
              </div>
            </button>
            </a>
          </div>
          <div className="card card--white">
            <div className="currency-icon2">
              <img alt="SwapECAT" src={"images/bnb-cat.svg"} />
            </div>
            <div className="card__header">
